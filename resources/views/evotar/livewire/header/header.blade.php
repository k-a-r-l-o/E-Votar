<div class="flex items-center justify-between w-full z-50 " x-data="{ sidebarOpen: false, isActive: false }">
            ...
            <x-slot name="trigger">
                <button class="focus:outline-none flex items-center space-x-2">
                    ...
                    <div class="hidden md:block">
                        <p class="text-left text-gray-900 tracking-tight uppercase font-semibold text-[12px] whitespace-nowrap">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-start bg-black bg-opacity-50"
         x-cloak
         x-show="sidebarOpen"
